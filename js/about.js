...
const GROUPS = [
  {
    ...
    skills: [
      ...
      { name: 'Node.js',      size: 2 },
      { name: 'Next.js',      size: 2 },
      { name: 'React Native', size: 2 },
      { name: 'PostgreSQL',   size: 1 },
      { name: 'Vue.js',       size: 1 },
      { name: 'CSS/Sass',     size: 2 },
      { name: 'REST APIs',    size: 1 },
    ],
  },
  {
    id: 'des',
    ...
    skills: [
      { name: 'Figma',             size: 3 },
      { name: 'UI Design',         size: 3 },
      { name: 'UX Research',       size: 3 },
      { name: 'Prototyping',       size: 2 },
      { name: 'Design Systems',    size: 2 },
      { name: 'Motion Design',     size: 2 },
      { name: 'Interaction Design',size: 2 },
      { name: 'Wireframing',       size: 1 },
    ],
  },
  {
    id: 'tools',
    ...
    skills: [
      { name: 'After Effects', size: 2 },
      { name: 'Illustrator',   size: 3 },
      { name: 'Photoshop',     size: 2 },
      { name: 'VS Code',       size: 1 },
      { name: 'Git',           size: 1 },
      { name: 'Framer',        size: 2 },
      { name: 'Notion',        size: 1 },
...
const PRINCIPLES = [
  'Design is a decision-making framework, not a decoration layer.',
  'The best code is the code your users never have to think about.',
  'Research earns the right to design with confidence.',
  'Ship it, learn from it, make it better.',
];

const STATS = [
  { value: 6,   suffix: '+', label: 'Years of experience',  animate: true,  decimals: 0 },
  { value: 40,  suffix: '+', label: 'Projects shipped',     animate: true,  decimals: 0 },
  { value: 3,   suffix: '',  label: 'Disciplines mastered', animate: true,  decimals: 0 },
