...
const PROJECTS = [
  {
    ...
    description:
      'A real-time analytics platform for enterprise teams. Redesigned the entire data visualization layer, reducing time-to-insight by 60%.',
    role: 'Lead Designer & Developer',
    color: '#6C63FF',
    initial: 'N',
    template: 'feature-split',
    steps: [
      { label: 'Discovery',    desc: 'Stakeholder interviews and competitive analysis across 12 enterprise tools.' },
      { label: 'Wireframes',   desc: 'Low-fidelity flows mapped to 8 core user jobs-to-be-done.' },
      { label: 'Build',        desc: 'React + TypeScript with a custom D3 visualization layer.' },
      { label: 'Ship',         desc: 'Rolled out to 4,200 enterprise seats. Zero critical bugs at launch.' },
    ],
  },
  {
    id: 1,
    name: 'Forma Studio',
    category: 'Brand Identity · UI Design',
    year: '2024',
    tags: ['Figma', 'After Effects', 'Illustrator'],
    description:
      'Complete visual identity system for a Scandinavian architecture firm. From logo to digital product, every touchpoint designed as a cohesive system.',
    role: 'Brand Designer',
    color: '#C96A50',
    initial: 'F',
    template: 'offset-tilt',
    steps: [
      { label: 'Discovery',    desc: 'Brand audit and moodboarding with the founding partners.' },
      { label: 'Wireframes',   desc: 'Logomark explorations — 3 directions, 2 rounds of refinement.' },
      { label: 'Build',        desc: '64-page brand guidelines and Figma component library.' },
      { label: 'Ship',         desc: 'Full rollout across print, web, and environmental signage.' },
    ],
  },
  {
    id: 2,
    ...
    year: '2023',
    tags: ['React Native', 'Figma', 'User Testing'],
    description:
      'A focus and flow state app for remote workers. 14 weeks of research, 3 major pivots, and a 4.8 star launch rating.',
    role: 'UX Lead · iOS Developer',
    color: '#39FF7A',
    initial: 'D',
    template: 'type-watermark',
    steps: [
      { label: 'Discovery',    desc: '42 user interviews and 200+ survey responses across 6 countries.' },
      { label: 'Wireframes',   desc: 'Rapid prototyping — 3 pivots based on continuous usability testing.' },
      { label: 'Build',        desc: 'React Native with custom audio engine and haptic feedback system.' },
      { label: 'Ship',         desc: 'Launched with 4.8 App Store rating in the first 30 days.' },
    ],
  },
  {
    id: 3,
    ...
    year: '2023',
    tags: ['Node.js', 'PostgreSQL', 'Vue'],
    description:
      'Headless CMS built for content teams who hate their tools. Ships with a visual query builder and real-time collaboration.',
    role: 'Full-Stack Developer',
    color: '#00E5FF',
    initial: 'H',
    template: 'editorial-row',
    steps: [
      { label: 'Discovery',    desc: 'Pain-point mapping from 15 content teams across 3 industries.' },
      { label: 'Wireframes',   desc: 'Architecture design: REST + GraphQL hybrid with live preview.' },
      { label: 'Build',        desc: 'Node.js API, PostgreSQL schema, Vue 3 admin panel from scratch.' },
      { label: 'Ship',         desc: 'Open-sourced with 900 GitHub stars in the first month.' },
    ],
  },
];
